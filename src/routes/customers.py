...
from src.repository.schemas.customers import InputCustomersSchema
...
async def set_customer(customer_schema: InputCustomersSchema,
    ...
    customer_id = await CustomersService(customers_repository).set_obj_schema(customer_schema.__dict__)
...
async def update_customer(customer_id: int,
    ...
    updated_customer_id = await CustomersService(customers_repository).update_obj_schema(customer_id, customer_schema.__dict__)
    return {"updated_customer_id": updated_customer_id}
...
async def delete_customer(customer_id: InputCustomersSchema,
    ...
    deleted_customer_id = await CustomersService(customers_repository).delete_obj_schema(customer_id)
    return {"deleted_customer_id": deleted_customer_id}
